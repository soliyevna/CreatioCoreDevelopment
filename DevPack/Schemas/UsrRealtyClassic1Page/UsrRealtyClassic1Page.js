	...
	return {
		...
		methods: {
			...
			getWebServiceResult: function(response, success) {
				this.console.log("3");
				this.Terrasoft.showInformation("Total amount byr type: " + response.GetTotalAmountByTypeIdResult + ", success: " + success);
			}
		},
		...
		diff: /**SCHEMA_DIFF*/[
			{
				"operation": "insert",
				"name": "UsrName31e13026-e5ba-43ca-9a7a-dd03ff9ff28a",
				"values": {
					"layout": {
						"colSpan": 24,
						"rowSpan": 1,
			...
			{
				"operation": "insert",
				"name": "UsrPrice2ede35ab-5843-49d9-9091-aa56517faad9",
				"values": {
					"layout": {
						"colSpan": 24,
						"rowSpan": 1,
			...
			{
				"operation": "insert",
				"name": "UsrAreae89c759c-420f-4c2e-93dd-527474a13e3b",
				"values": {
					"layout": {
						"colSpan": 24,
						"rowSpan": 1,
			...
			{
				"operation": "insert",
				"name": "LOOKUPf14556cc-ad1e-43d7-aceb-3c52ab2314ce",
				"values": {
					"layout": {
						"colSpan": 12,
						"rowSpan": 1,
			...
			{
				"operation": "insert",
				"name": "LOOKUP0519e7d6-b6e4-4f50-8683-d1f33fb3dbe6",
				"values": {
					"layout": {
						"colSpan": 12,
						"rowSpan": 1,
			...
			{
				"operation": "insert",
				"name": "STRINGf44625b3-d29d-4a60-ba89-bba59611eb6c",
				"values": {
					"layout": {
						"colSpan": 12,
						"rowSpan": 2,
